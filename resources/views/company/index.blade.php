...
<a class="btn btn-success" href="/comp/create">Tambah Post Baru</a>
	...
	<p>Cari Data Post :</p>
				...
				<form action="/comp/cari" method="GET" class="form-inline">
    ...
    <table class="table table-striped table-md">
		...
		<tr>
			...
			<td>
				<a class="btn btn-info" href="/comp/edit/{{ $p->id_loker }}">Edit</a>
				|
				<a class="btn btn-danger" href="/comp/destroy/{{ $p->id_loker }}">Hapus</a>
			</td>
		</tr>
		@endforeach
	</table>
